...
public:
    ...
    ListNode* middleNode(ListNode* head) {
        ...
        while(fast != NULL /* fast->next != NULL for getting 3 in 6. */) { 
            fast = fast ->next;
            if(fast != NULL /* fast->next != NULL for getting 3 in 6. */) {
                fast = fast -> next;
...
// Cycle Check in Linked List using Hashing 
class Solution4 {
public:
    bool hasCycleUsingMaps(ListNode *head) {
